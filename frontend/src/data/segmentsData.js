...
export const segmentsDatabase = {
  ...
  features: [
    { title: "Operação", desc: "Comandas, mesas e pedidos em tempo real.", icon: Smartphone },
    { title: "Estoque Inteligente", desc: "Baixa automática por ficha técnica.", icon: Receipt },
    { title: "Cozinha (KDS)", desc: "Controle de tempo e pedidos em tela.", icon: ChefHat },
    { title: "Autoatendimento", desc: "Cardápio QR direto na mesa.", icon: QrCode },
    { title: "Financeiro", desc: "Caixa e fechamento seguro.", icon: Calculator },
  ],
  ...
  plans: [
    {
      ...
      desc: "Teste completo sem limitações.",
      icon: Coffee,
      features: [
        "PDV + Caixa",
        "Mesas e Comandas",
      ...
      trialNote: "Acesso completo ao Professional por 14 dias.",
    },
...

    {
      ...
      name: "Professional",
      price: 299,
      yearlyPrice: 249, // 🔥 anual com desconto forte
      desc: "Gestão completa e alta performance.",
      icon: Building2,
      popular: true,
      features: [
        "Tudo do Starter",
...

    {
      ...
      name: "Enterprise",
      price: null,
      desc: "Escala e operação multiunidade.",
      icon: Shield,
      features: [
